...
public class MyAccountController {
    ...
    public String showMyAccount(Model model,Principal principal){
        ...
        try {
            ...
            model.addAttribute("userLikedProducts",userLikedProducts.stream().collect(toMap(Product::getProductId, Function.<Product> identity())));
            model.addAttribute("userDislikedProducts",userDislikedProducts.stream().collect(toMap(Product::getProductId, Function.<Product> identity())));
